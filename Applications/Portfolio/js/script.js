...
{
    console.log('Redirecting to https://www.hackerrank.com/profile/codeks7407');
    window.open('https://www.hackerrank.com/profile/codeks7407', '_blank');
}
...
//disable right click and and f12 button
...
(function() 
{
    emailjs.init("eeB57utvnq6u9ChKW");
})();
...
document.getElementById("commentForm").addEventListener("submit", function(event) 
{
    ...
    emailjs.sendForm("service_f91slrd", "template_ccohf2h", this) 
...
{
	sendBtn.style.backgroundColor = "tomato";
...
const images = 
[
    "images/special/Hoodie-guy.png",
    "images/special/Profile2.png",
    "images/special/Profile3.png",
    "images/special/kh.png",
    "images/special/kh2.png"
];
...
document.addEventListener("DOMContentLoaded", function () 
{
    ...
    (function () 
	{
		...
		const onLoad = function () 
		{
            ...
            script.id = "PE5hQ4emw_sdIAjjv1q34"; 
    ...
    chatBtn.addEventListener("click", function () 
	{
        if (!chatFrame.src) 
		{
            chatFrame.src = "https://www.chatbase.co/chatbot-embed/PE5hQ4emw_sdIAjjv1q34";
        }
